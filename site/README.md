...
- BMP_GITHUB_ZIP_URL=https://github.com/mentaliss/bukabmp/releases/download/v1.1.0/BMP-Terbuka-v1.1.0.zip

The manual-download URL targets the current stable v1.1.0 GitHub Release asset.
