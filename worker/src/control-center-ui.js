...
.preview{border:1px dashed #cfcfc7;border-radius:12px;background:#fafaf8;padding:14px;min-height:110px}.previewOnly{font-size:9px;font-weight:750;letter-spacing:.05em;color:#8a5b00;margin-bottom:8px}.adCard{max-width:520px;border:1px solid #deded8;border-radius:12px;background:#fff;padding:12px}.adMedia{display:flex;align-items:center;justify-content:center;background:transparent;overflow:hidden;margin:0;max-height:300px}.adMedia img,.adMedia video{display:block;width:100%;height:auto;max-height:300px;object-fit:contain}.label{font-size:9px;text-transform:uppercase;letter-spacing:.08em;color:#777}.headline{font-weight:700;margin-top:5px}.bodyCopy{font-size:11px;line-height:1.5;color:#444;margin-top:5px}.cta{display:inline-block;margin-top:9px;font-size:10px;text-decoration:underline}.disclaimer{font-size:9px;color:#888;margin-top:7px}
